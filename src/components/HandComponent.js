...
const SilverRing = process.env.PUBLIC_URL + "/models/SilverRing.fbx";
const TiffanyRing = process.env.PUBLIC_URL + "/models/TiffanyRing.fbx";
const GoldRing = process.env.PUBLIC_URL + "/models/GoldRing.fbx";
const DetailedRing = process.env.PUBLIC_URL + "/models/DetailedRing.fbx";
const HXRC = process.env.PUBLIC_URL + "/logos/HXRC_logo.png";
