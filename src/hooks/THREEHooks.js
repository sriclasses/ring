...
const RingTop = process.env.PUBLIC_URL + "/models/Ring_Top_fixed.fbx";
const RingBottom = process.env.PUBLIC_URL + "/models/Ring_Bottom.fbx";
const SRingTop = process.env.PUBLIC_URL + "/models/SilverRing1.fbx";
const SRingBottom = process.env.PUBLIC_URL + "/models/SilverRing2.fbx";
const DRingTop = process.env.PUBLIC_URL + "/models/DetailedRing1.fbx";
const DRingBottom = process.env.PUBLIC_URL + "/models/DetailedRing2.fbx";
const HAND = process.env.PUBLIC_URL + "/models/FixedAgainHand.fbx";
